...
<table className="studentTable">
            ...
            <div className='paginationDiv'>
                ...
                <button className='paginationButtonsArrows'  onClick={() => handlePageChange(currentPage - 1)} disabled={currentPage === 1} style={{color: currentPage === 1 ? 'gray' : 'black',cursor: currentPage === 1 ? 'not-allowed' : 'pointer' ,backgroundColor: currentPage === 1 ? "blanchedalmond":"skyblue"  }}>
  ...
  <path d="M16 14a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V2a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2zm-4.5-6.5H5.707l2.147-2.146a.5.5 0 1 0-.708-.708l-3 3a.5.5 0 0 0 0 .708l3 3a.5.5 0 0 0 .708-.708L5.707 8.5H11.5a.5.5 0 0 0 0-1"/>
                ...
                <button className='paginationButtons' onClick={() => handlePageChange(1)} disabled={currentPage === 1} style={{color: currentPage === 1 ? 'gray' : 'black',cursor: currentPage === 1 ? 'not-allowed' : 'pointer' ,backgroundColor: currentPage === 1 ? "blanchedalmond":""  }}>
                    1
                </button>

                {currentPage > 3 && <span>....</span>}
                {getPaginationRange().map((pageNumber) => (
                    <button style={{margin:"0px",color: currentPage === pageNumber ? "gray" : "black",cursor: currentPage === pageNumber ? 'not-allowed' : 'pointer',backgroundColor: currentPage === pageNumber ? "blanchedalmond":"" }} className='paginationButtons'
                        key={pageNumber}
                ...
                {totalPages > 1 && (
                    <button style={{margin:"0px",color: currentPage === totalPages ? 'gray' : 'black',cursor: currentPage === totalPages ? 'not-allowed' : 'pointer',backgroundColor: currentPage === totalPages ? "blanchedalmond":""  }} className='paginationButtons' onClick={() => handlePageChange(totalPages)} disabled={currentPage === totalPages}>
                        {totalPages}
                    </button>
                )}

                <button className="paginationButtonsArrows" onClick={() => handlePageChange(currentPage + 1)} disabled={currentPage === totalPages} style={{color: currentPage === totalPages ? 'gray' : 'black',cursor: currentPage === totalPages ? 'not-allowed' : 'pointer' ,backgroundColor: currentPage === totalPages ? "blanchedalmond":"skyblue" }}>
